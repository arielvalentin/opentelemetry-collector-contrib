...
require (
	github.com/DataDog/datadog-agent/pkg/proto v0.50.0-rc.5
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.50.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.50.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/trace v0.50.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.50.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.50.0-rc.5 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.50.0-rc.5 // indirect
	...
	github.com/DataDog/opentelemetry-mapping-go/pkg/inframetadata v0.8.2 // indirect
	github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/attributes v0.8.2 // indirect
	github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/logs v0.8.2 // indirect
	github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/metrics v0.8.2 // indirect
	github.com/DataDog/opentelemetry-mapping-go/pkg/quantile v0.8.2 // indirect
